...
# =========================================================================
# BLOQUE FRAGMENTADO ANTI-PARPADEO (ACTUALIZACIÓN SILENCIOSA)
# =========================================================================
@st.fragment(run_every=3.0)
def renderizar_cuerpo_principal():
    global menu_principal_opcion
    
    # Sincronizamos cambios globales en segundo plano sin redibujar toda la app
...
# Ejecutamos el fragmento principal sincronizado sin parpadeos
renderizar_cuerpo_principal()
