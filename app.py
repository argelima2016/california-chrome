...
def inicializar_estado_global():
    ...
    if 'usuario_activo' not in st.session_state:
        st.session_state.usuario_activo = "LUIS"  # Jugador actual registrado/activo en la sesión
...
# =========================================================================
# 3. MÓDULO DE CUENTAS (SOLO DEUDA ACTUAL E HISTORIAL DEL JUGADOR ACTIVO)
# =========================================================================
    ...
    # Se eliminó por completo el selector de jugadores. Se toma directamente el usuario activo.
    ...
    # Tarjetas informativas de deuda actual
    ...
    # Filtrar el historial de jugadas exclusivamente para el jugador activo
