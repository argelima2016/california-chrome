...
# =========================================================================
# CONTENEDOR AISLADO ESTRICTO POR CADA MÓDULO PRINCIPAL
# =========================================================================

# 1. MÓDULO DE REMATES
if menu_principal_opcion == "Remates":
    container_remates = st.container()
    with container_remates:
        st.markdown('<div class="carrusel-horizontal-box">', unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        container_dupletas = st.container()
        with container_dupletas:
            st.markdown('<div class="carrusel-horizontal-box">', unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        container_cuentas = st.container()
        with container_cuentas:
