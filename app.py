...
def procesar_texto_flexible(texto_a_procesar):
    try:
        ...
        for linea in lineas:
            ...
            # Detección de cabecera de carrera
            if "carrera" in linea_lower or any(k in linea_lower for k in map_numeros.keys()):
                ...
                if carrera_actual_detectada:
                    ...
                    # Extraer detalles de condición, distancia y hora si vienen en la misma línea
                    cond = linea_limpia
                    dist = "Por definir"
                    hora = "Por definir"
            ...
            # Si ya tenemos carrera activa, buscar ejemplares
            if carrera_actual_detectada:
                # Extraer distancia u hora en líneas secundarias si faltaban
