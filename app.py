...
# =========================================================================
    ...
    # Definir listas específicas de carreras habilitadas según la sección (configuradas en Zona Admin)
    if sub_dup_actual == "Dupleta":
        ...
        carreras_permitidas = st.session_state.carreras_habilitadas_tripleta
        num_legs = 3
    else:
        ...
        carreras_permitidas = st.session_state.carreras_habilitadas_polla
    ...
    if not carreras_permitidas:
        ...
        # Claves de estado para congelar/fijar las selecciones una vez emitido el ticket
...
# =========================================================================
    ...
    if tab_actual == "✍️ Banco de Caballos":
        ...
        st.markdown("---")
        with st.container(border=True):
            st.markdown("🏇 **Carreras Habilitadas por Sección**")
