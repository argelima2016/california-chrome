...
# --- ESTILOS CSS (DISEÑO MÁS ELEGANTE Y ADAPTADO A MONITORES / PC) ---
st.markdown("""
    <style>
    .stApp {
...
# --- CARRUSEL AUTOMÁTICO DE IMÁGENES DEL HIPÓDROMO LA RINCONADA (AJUSTADO A 8 SEGUNDOS) ---
...
if lista_b64_banners:
    ...
    # Carrusel optimizado a 8000 ms (8 segundos) y mejor adaptación a monitores de PC
    html_slider = f"""
    <style>
